...
gg1<-ggplot(data=trainp, aes(x=sex, fill = as.factor(dropout)))+  geom_bar() + facet_grid (~race)+ theme(legend.position="top")
+ labs(fill="Dropout") #+geom_bar(aes(fill=dropout), position="stack")
...
```{r glm_table, echo=FALSE, warning=FALSE, out.width=".49\\linewidth", fig.show="hold", include=FALSE}
knitr::kable(
